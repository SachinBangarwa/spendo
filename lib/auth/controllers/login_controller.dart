...
class LoginController extends GetxController {
  ...
  Future<User?> loginCloud(String email, String password) async {
    try {
      ...
      switch (e.code) {
        case 'user-not-found':
          showCustomSnackBar('Error', 'No user found for this email.', isSuccess: false);
          break;
        case 'wrong-password':
          showCustomSnackBar('Error', 'Incorrect password. Please try again.', isSuccess: false);
          break;
        case 'invalid-email':
          showCustomSnackBar('Error', 'The email address is not valid.', isSuccess: false);
          break;
        case 'user-disabled':
          showCustomSnackBar('Error', 'This account has been disabled.', isSuccess: false);
          break;
        default:
